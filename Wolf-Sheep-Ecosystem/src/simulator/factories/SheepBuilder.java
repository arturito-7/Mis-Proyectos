...
public class SheepBuilder extends Builder<Animal>{
	...
	public SheepBuilder(Factory<SelectionStrategy> factoria) {
		super("sheep", "Es un Builder de Sheep");
	...
	protected Sheep create_instance(JSONObject data) {
		...
		return new Sheep(data.has("mate_strategy") ? this._factoria.create_instance(data.getJSONObject("mate_strategy")) : new SelectFirst(),
				data.has("danger_strategy") ? this._factoria.create_instance(data.getJSONObject("danger_strategy")) : new SelectFirst(),
