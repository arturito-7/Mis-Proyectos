...
public class Messages {
	...
	public static final String SUPERLASER_ERROR = "SuperLaser cannot be shot";
	...
	public static final String LASER_EN_TABLERO = "There is already a laser on the board";
	
	public static final String NOT_ENOUGH_POINTS = "Not enough points: only %s points, 5 points required";
	
	public static final String NO_SHOCKWAVE_DISPONIBLE = "You have NO ShockWave avaliable";
	
	public static final String OFF_WORLD_1 = "Cannot move in direction ";
	
	public static final String OFF_WORLD_2 = " from position ";
	...
	public static final String FILE_ERROR = "An error occurred while reading the file: ";
	
	public static final String UNKNOWN_SHIP = "Unknown ship: ";
	
	public static final String INCORRECT_ENTRY = "Incorrect entry ";
	
	public static final String OFF_BOARD = " position is off board";
	
	public static final String SHOW_POSITION = "(%s, %s)";
	...
	public static final String COMMAND_SHOOT_SUPERLASER_NAME = "superLaser";
	public static final String COMMAND_SHOOT_SUPERLASER_SHORTCUT = "sl";
	public static final String COMMAND_SHOOT_SUPERLASER_DETAILS = "[s]uper[L]aser";
	public static final String COMMAND_SHOOT_SUPERLASER_HELP = "shoots a super laser when player has enough points";
