...
contract contratoTop {
    ...
    // --- Mint / Burn ---
    function mint(address to, uint256 tokenId, string memory uri) public onlyMinter whenNotPaused {
    ...
    function burn(uint256 tokenId) public onlyBurner whenNotPaused {
